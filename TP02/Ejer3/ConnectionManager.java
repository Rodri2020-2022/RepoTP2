...
public class ConnectionManager {
    private static final String DRIVER = "com.mysql.jdbc.Driver"; //driver para mysql
    private static final String URL_DB = "jdbc:mysql://localhost:3306/";// cadena de conexion
    protected static String DB = "db_ejer3_tp2";//nombre de la base de datos
